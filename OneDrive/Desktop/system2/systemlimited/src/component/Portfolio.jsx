...
const Portfolio = () => {
  ...
  return (
    <>
      <section className="pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] dark:bg-dark overflow-y-auto overflow-x-hidden">
        <div className="container mx-auto">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[510px] text-center">
                <span className="text-primary mb-2 block text-lg font-semibold text-blue-900">
                  Our Portfolio
                </span>
                ...
                Take a look at some of our latest projects that showcase our expertise in delivering br high-quality IT solutions. We’re proud to partner with businesses to create impactful, results-driven digital experiences.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="relative mb-12">
          ...
          <div className="relative z-10 mx-7 -mt-20 rounded-lg bg-white dark:bg-dark-2 py-[34px] px-3 text-center shadow-portfolio dark:shadow-box-dark">
            ...
            <h3 className="text-dark dark:text-blue-900 mb-5 text-xl font-bold">{title}</h3>
            <a
              href={buttonHref}
